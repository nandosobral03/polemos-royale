...
export default function CreateTeamButton({ players, sponsors }: { players: Player[], sponsors: Sponsor[] }) {
        ...
        <Dialog open={open} onOpenChange={handleOpenClose}>
            ...
            <DialogContent>
                ...
                <DialogDescription className="flex flex-col gap-2">
                    <div className="flex flex-col gap-1">
                        ...
                        <Input id="name" placeholder="Team name"
                            autoComplete="off"
                            value={team.name} onChange={(e) => setTeam({ ...team, name: e.target.value })} />
                    </div>
                    <div className="flex flex-col gap-1">
                        <label htmlFor="sponsor">Sponsor</label>
                        <Select value={team.sponsorId?.toString()} onValueChange={(value) => setTeam({ ...team, sponsorId: value ? parseInt(value) : null })}>
                ...
                <DialogFooter>
                    ...
                    <Button variant="default" size="sm" onClick={() => handleCreateTeam()} disabled={!team.name || createTeamMutation.isPending}>
                        Create
                    </Button>
                </DialogFooter>
            </DialogContent>
